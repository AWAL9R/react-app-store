        ...
        <div className='bg-[#D2D2D2]'>
            <div className='container py-15'>
                <div className='flex gap-5'>
                    <div><img className='w-[300px] xh-[300px]' src={image?image:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/2048px-No_image_available.svg.png"} /></div>
                    <div className='w-full flex flex-col justify-between'>
                        ...
                        <div className='flex gap-15'>
                            <div>
                                <div className='text-4xl text-green-500'><FaDownload /></div>
                                <div>Downloads</div>
                                <div className='text-4xl font-extrabold'>{downloads}M</div>
                            </div>
                            <div>
                                <div className='text-4xl text-yellow-500'><FaStar /></div>
                                <div>Average Ratings</div>
                                <div className='text-4xl font-extrabold'>{ratingAvg}</div>
                            </div>
                            <div>
                                <div className='text-4xl text-blue-500'><MdReviews /></div>
                                <div>Total Reviews</div>
                                <div className='text-4xl font-extrabold'>{reviews}</div>
                            </div>
                        </div>
