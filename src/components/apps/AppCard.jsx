...
const AppCard = ({ app }) => {
    ...
    return (
        <Link to={`/apps/${id}`}>
            <div className='flex flex-col gap-2 bg-white hover:bg-purple-100 hover:scale-105 transition ease-in-out justify-center items-center p-3 rounded-md'>
                <img src={image?image:"https://upload.wikimedia.org/wikipedia/commons/thumb/a/ac/No_image_available.svg/2048px-No_image_available.svg.png"} alt="" className='w-full aspect-square xbg-gray-500' />
...
export const AppCardInline = ({ app, isInstalled, removeInstalled }) => {
    ...
    return (
        <Link to={`/apps/${id}`}>
            <div className='flex flex-wrap w-full gap-2 bg-white hover:bg-purple-100 hover:scale-102 transition ease-in-out  items-center p-3 rounded-md my-3'>
