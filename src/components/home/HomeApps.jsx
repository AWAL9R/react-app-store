    ...
    return (
        <div className=' bg-[#D2D2D2] py-10 flex flex-col items-center gap-7'>
            <div className='text-center flex flex-col gap-7'>
                <div className=' text-5xl font-bold '> {isHome ? "Trending Apps" : "Our All Applications"}</div>
                <div className='text-[#627382] text-[20px]'>{isHome ? "Explore All Trending Apps on the Market developed by us" : "Explore All Apps on the Market developed by us. We code for Millions"}</div>
            </div>
