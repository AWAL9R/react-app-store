    ...
    return (
        <div className='container flex items-center flex-col gap-7 pt-20 max-[800px]:pt-12 max-[600px]:pt-9 max-[500px]:pt-6'>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <a href={PlayStoreLink} target='_blank' className='flex gap-2 border-1 border-gray-400 py-3 px-7 hover:bg-gray-300 hover:scale-105 transition ease-in-out max-[500px]:py-2 max-[500px]:px-4'><img src='playstore.png' className='w-[30px] h-[30px]' /><button>Google Play</button></a>
                <a href={AppStoreLink} target='_blank' className='flex gap-2 border-1 border-gray-400 py-3 px-7  hover:bg-gray-300 hover:scale-105 transition ease-in-out max-[500px]:py-2 max-[500px]:px-4'><img src='appstore.png' className='w-[30px] h-[30px]' /><button>App Store</button></a>
            </div>
