    ...
    return (
        <div className=' flex items-center flex-col gap-7 pt-20'>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <a href={PlayStoreLink} className='flex gap-2 border-1 border-gray-400 py-3 px-7'><img src='playstore.png' className='w-[30px] h-[30px]' /><button>Google Play</button></a>
                <a href={PlayStoreLink} className='flex gap-2 border-1 border-gray-400 py-3 px-7'><img src='appstore.png' className='w-[30px] h-[30px]' /><button>App Store</button></a>
            </div>
