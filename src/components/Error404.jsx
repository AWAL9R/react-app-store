...
const Error404 = () => {
    return (
        <div className='flex flex-col justify-center items-center my-20 gap-7'>
            ...
            <div><Link to="/"><button className='bg-linear-to-br from-[#632EE3] to-[#9F62F2] flex gap-1 items-center rounded-md p-3 text-white font-bold text-[20px]'>Go Home!</button></Link></div>
        </div>
    );
};
